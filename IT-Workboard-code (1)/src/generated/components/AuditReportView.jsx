...
const containerRef = useRef(null);
  ...
  const stats = useMemo(() => {
    ...
    const completed = items.filter(i => i.status === 'Done' || i.completionStatus === 'Completed').length;
    const inProgress = items.filter(i => i.status === 'In Progress' || i.completionStatus === 'In Progress').length;
