...
const DETAIL_COLUMNS = [
  'person', 'status', 'priority', 'completionStatus', 'projOp',
  'annualCostBhd', 'monthlyCostBhd', 'nextDueDate',
  'blockersrisks', 'infrastructureType', 'taskDescription',
  'slaHours',
  'awsServerCount', 'assignedTeam', 'vendor',
  'frequency'
];
...
function ExpandedDetail({ item }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <div className="space-y-4">
        <DetailField label="Completion Status" value={item.completionStatus}>
...
<div className="md:col-span-2 space-y-4 pt-2 border-t border-border/40">
    ...
    {item.taskDescription && <DetailField label="Task Description" value={item.taskDescription} />}
      </div>
